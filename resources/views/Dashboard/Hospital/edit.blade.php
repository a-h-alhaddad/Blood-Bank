...
<form action="{{ route('blood_bank_request.update',$blood_bank_request->id) }}" method="POST" enctype="multipart/form-data">
...
<input type="text" name="last_name" class="form-control" placeholder="blood group"  value="<?php echo $request->quantity; ?>" >
