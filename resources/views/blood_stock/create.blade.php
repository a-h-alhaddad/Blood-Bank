...
<div class="pull-left mb-2">
  ...
  <h3 class="mb-4" style="font-family: 'Cairo', sans-serif; ">اضافة مخزون</h3>
  
</div>

<div class="pull-right">

<a class="btn btn-primary" href="{{ route('blood_stock.index') }}"> Back</a>
...
<form action="{{ route('blood_stock.store') }}" method="POST" enctype="multipart/form-data">
