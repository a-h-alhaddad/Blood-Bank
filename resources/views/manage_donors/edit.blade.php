...
<a class="btn btn-primary" href="{{ route('manage_donor.index') }}"> رجوع</a>
...
<form action="{{ route('manage_donor.update',$donor->id) }}" method="POST" enctype="multipart/form-data">
...
<input type="text" name="name" class="form-control" placeholder="الإسم" value="<?php echo $donor->name; ?>">
...
<input type="email" name="email" class="form-control" placeholder="إيميل"  value="<?php echo $donor->email; ?>">
...
<select name="blood_group_id" class="form-control mt-2">
...
<input type="text" name="card" class="form-control" placeholder="رقم الهوية" value="<?php echo $donor->card; ?>" >
...
<div class="col-xs-6 col-sm-6 col-md-6">
    ...
    <input type="text" name="address" class="form-control" placeholder="العنوان" value="<?php echo $donor->address; ?>">
    ...
    <div class="col-xs-6 col-sm-6 col-md-6">
        ...
        <input type="text" name="number" class="form-control" placeholder="رقم الجوال" value="<?php echo $donor->number; ?>">
    ...
    <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{ route('manage_donor.index') }}">
                  <div class="text-white text-center ms-2 d-flex align-items-center justify-content-center">
                  </div>
