<x-guest-layout>
    <form method="POST" action="{{ route('register.donor') }}" dir="rtl">
        ...
        <div>
            <x-input-label for="card" :value="__('رقم الهوية')" />
            <x-text-input id="card" class="block mt-1 w-full" type="text" name="card" :value="old('card')" required autofocus autocomplete="card" />
        ...
        <div>
            <x-input-label for="number" :value="__('رقم الجوال')" />
        ...
        <div class="mt-2">
            <x-input-label :value="__('فصيلة الدم')" />
