...
<form action="{{ route('manage_hospital.update',$Hospital->id) }}" method="POST" enctype="multipart/form-data">
...
<input type="text" name="name" class="form-control" placeholder="الاسم" value="<?php echo $Hospital->name; ?>">
...
<input type="text" name="address" class="form-control" placeholder="العنوان"  value="<?php echo $Hospital->address; ?>" >
...
<input type="txt" name="number" class="form-control" placeholder="الرقم"  value="<?php echo $Hospital->number; ?>">
...
<body class="g-sidenav-show rtl bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
    ...
    <div class="container mt-2">
        ...
        <h2>تحديث المستشفى</h2>
        
        </div>
        
        <div class="pull-right">
        
        <a class="btn btn-primary" href="{{ route('manage_hospital.index') }}"> رجوع</a>
